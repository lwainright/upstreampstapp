  ...
  if (isSubScreen) {
    return (
      <div style={{
        ...
        {/* Back button - own row */}
        <div style={{ width: "100%", maxWidth: lc.maxW, padding: `8px ${lc.isDesktop ? 40 : 16}px 4px`, display: "flex", alignItems: "center" }}>
          <div onClick={onBack} style={{ cursor: "pointer", color: "#38bdf8", display: "flex", alignItems: "center", gap: 5, fontSize: 13, fontWeight: 800, background: "rgba(56,189,248,0.12)", border: "1.5px solid rgba(56,189,248,0.35)", borderRadius: 10, padding: "7px 14px" }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="15 18 9 12 15 6"/></svg>
            Back
          </div>
        </div>
        {/* Logo - own row below back button */}
        {logoSrc && (
          <div style={{ width: "100%", display: "flex", justifyContent: "center", padding: "0 24px 2px" }}>
            <LogoImg src={logoSrc} style={{ width: "80%", maxWidth: 320, height: "auto", objectFit: "contain" }}/>
          </div>
        )}
