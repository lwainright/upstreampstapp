...
export default function HomeScreen({
  ...
  return (
    ...
    <Screen headerProps={{ title: agency ? agency.name : "Upstream", agencyName: agency?.name, logoSrc }}>
      ...
      {criticalIncident && (
        <div className={lc.isDesktop ? "full-width" : ""} style={{
          ...
          <div style={{
            ...
            background: "#334155", border: "2px solid #64748b", flexShrink: 0,
          }}/>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: "#f1f5f9", letterSpacing: "0.08em" }}>
              CRITICAL INCIDENT SUPPORT AVAILABLE
            </div>
            <div style={{ fontSize: 11, color: "#64748b", marginTop: 2 }}>
              Your PST team is standing by. Human PST is recommended.
            </div>
          </div>
        </div>
      )}
      ...
      {pstAlert && !criticalIncident && (
        <div className={lc.isDesktop ? "full-width" : ""} style={{
          ...
          <div style={{
            ...
            background: "#8b5cf6", boxShadow: "0 0 8px rgba(139,92,246,0.8)", flexShrink: 0,
          }}/>
          <div>
      ...
      {agencyNotification && (
        <div className={lc.isDesktop ? "full-width" : ""} style={{
          background: agencyNotification.priority === "Urgent" ? "rgba(239,68,68,0.1)"
            : agencyNotification.priority === "Important" ? "rgba(234,179,8,0.1)"
            : "rgba(56,189,248,0.08)",
          border: `1.5px solid ${agencyNotification.priority === "Urgent" ? "rgba(239,68,68,0.3)"
            : agencyNotification.priority === "Important" ? "rgba(234,179,8,0.3)"
            : "rgba(56,189,248,0.2)"}`,
          borderRadius: 14, padding: "12px 16px",
          display: "flex", gap: 12, alignItems: "flex-start",
        }}>
          <div style={{ fontSize: 18, flexShrink: 0 }}>
            {agencyNotification.priority === "Urgent" ? "🚨"
              : agencyNotification.priority === "Important" ? "⚠️"
              : "📢"}
          </div>
          <div style={{ flex: 1 }}>
            <div style={{
            ...
            <div style={{ fontSize: 13, color: "#dde8f4", lineHeight: 1.6 }}>
              {agencyNotification.message}
            </div>
            <div style={{ fontSize: 10, color: "#3d5268", marginTop: 4 }}>
              {agencyNotification.timestamp}
            </div>
          </div>
          <div
            onClick={() => setAgencyNotification(null)}
      ...
      <div style={{
        ...
        alignItems: "center",
        gridColumn: lc.isDesktop ? "1/-1" : "auto",
      }}>
        <div>
          <div style={{
          ...
          <div style={{ fontSize: lc.isDesktop ? 24 : 21, fontWeight: 800, color: "#dde8f4", marginTop: 3 }}>
            How are you doing today?
          </div>
          <div style={{ fontSize: 12, color: "#8099b0", marginTop: 2 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {isAdminRole && (
            <div
              ...
              style={{
                ...
                cursor: "pointer", color: "#eab308", fontSize: 16,
              }}
            >
              ⚙️
            </div>
          ...
          {/* Gauge / Shift Stream */}
          <div
            onClick={() => setGaugeLevel((gaugeLevel + 1) % 4)}
            style={{
              cursor: "pointer", userSelect: "none",
              background: cur.bg,
              border: `1.5px solid ${cur.color}50`,
              borderRadius: 16, padding: "10px 13px",
              display: "flex", flexDirection: "column", alignItems: "center", gap: 4,
              boxShadow: pulse ? cur.glow : "none",
              transition: "box-shadow 0.3s",
            }}
          >
            <div style={{ fontSize: 10, fontWeight: 800, color: cur.color, letterSpacing: "0.1em", textTransform: "uppercase" }}>
              {cur.label}
            </div>
            <div style={{ display: "flex", gap: 3 }}>
              {gc.map((g, i) => (
                <div key={i} style={{
                  ...
                  background: i === gaugeLevel ? g.color : "rgba(255,255,255,0.08)",
      ...
      {/* 6 Home Tiles */}
      <div
        className={lc.isDesktop ? "full-width" : ""}
      ...
      {agency ? (
        ...
        >
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            flexShrink: 0, color: "#38bdf8", fontSize: 22,
          }}>
            🏢
          </div>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: "#8099b0", marginTop: 2 }}>
              Enter your agency code to unlock Human PST access
            </div>
          </div>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1e3a52" strokeWidth="2.5" style={{ flexShrink: 0 }}>
      ...
      <div className={lc.isDesktop ? "full-width" : ""} style={{
        ...
        <div style={{ fontSize: 12, color: "#2d4a66", lineHeight: 1.6 }}>
          No login required. Your check-ins and conversations are private.
          AI PST has no access to your identity or contact info.
        </div>
      </div>
