...
export default function PTSDInterruptionScreen({ navigate, agency }) {
  ...
  const tools = {
    ...
    highacuity: {
      label: "High Acuity", color: "#ef4444", icon: "⚠️",
      items: [
        { title: "After a Hard Case", steps: ["TAP_HIGHACUITY"] },
        { title: "After a Peds Case", steps: ["TAP_HIGHACUITY"] },
        { title: "After a Fatality", steps: ["TAP_HIGHACUITY"] },
      ]
    },
    crisis: {
