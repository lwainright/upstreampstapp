  ...
  return (
    <Screen headerProps={{ onBack: () => navigate("home"), title: "About", agencyName: agency?.name }}>
      ...
      <div className="full-width" style={{
        ...
        {tabs.map(t => (
          <div key={t.key} onClick={() => setTab(t.key)} style={tabStyle(t.key)}>
            {t.label}
          </div>
        ))}
      </div>
      ...
      {tab === "about" && (
        <>
          <div className="full-width" style={{
            ...
            {logoSrc && (
              <img
                ...
                style={{ width: "60%", maxWidth: 220, height: "auto", objectFit: "contain" }}
              />
            )}
            <div style={{
            ...
            {/* Triple-tap hidden login trigger */}
            <div
              onClick={handleLogoTap}
              title="Tap 3× for platform access"
              style={{
                width: 28, height: 28, borderRadius: "50%",
                background: "rgba(56,189,248,0.07)",
                border: "1.5px solid rgba(56,189,248,0.18)",
                display: "flex", alignItems: "center", justifyContent: "center",
                cursor: "pointer", fontSize: 14, marginTop: 2,
              }}
            >
              🔐
            </div>
          ...
          <Card>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.75, marginBottom: 12 }}>
              First responders face challenges most people will never experience. This app was
              created to provide support for those who spend their careers supporting everyone else.
            </p>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.75 }}>
              Our goal:{" "}
              <span style={{ color: "#dde8f4", fontWeight: 600 }}>
                make wellness support accessible, confidential, and built for the realities of the job.
              </span>
            </p>
          </Card>
          ...
          <Card>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.75 }}>
              To support the mental wellness and resilience of first responders by providing
              confidential tools, peer connection, and access to trusted support resources.
            </p>
          </Card>
          ...
          <Card style={{ background: "rgba(56,189,248,0.05)", borderColor: "rgba(56,189,248,0.15)" }} className="full-width">
            ...
            <p style={{ fontSize: 13, color: "#38bdf8", fontWeight: 600, lineHeight: 1.6 }}>
              Taking care of yourself is not weakness — it's part of staying effective in the job and healthy outside of it.
            </p>
          </Card>
        </>
      )}
      ...
      {tab === "founder" && (
        <>
          ...
          <Card style={{ background: "rgba(56,189,248,0.04)", borderColor: "rgba(56,189,248,0.12)" }}>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8, marginBottom: 12 }}>
              This app was created by someone who understands the job from the inside.
            </p>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8, marginBottom: 12 }}>
              After nearly three decades in EMS, I've seen firsthand the impact this profession
              can have on the people who serve in it.
            </p>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8 }}>
              For many years, the culture encouraged people to keep moving to the next call.
              That mindset has helped many perform under pressure — but also made it harder
              for some to seek support.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8 }}>
              The name comes from addressing problems{" "}
              <span style={{ color: "#dde8f4", fontWeight: 600 }}>before they become crises</span>
              {" "}— recognizing stress early and building resilience over time.
            </p>
          </Card>
          ...
          <Card>
            ...
            {[
              "Nearly 30 years in Emergency Medical Services",
              "Field Paramedic experience",
              "Communications / Dispatch experience",
              "Leadership and supervisory roles",
              "Peer support and wellness initiative experience",
            ].map((r, i) => (
              <div key={i} style={{
          ...
          <Card style={{ background: "rgba(56,189,248,0.04)", borderColor: "rgba(56,189,248,0.12)" }} className="full-width">
            <p style={{ fontSize: 13, color: "#38bdf8", fontWeight: 600, lineHeight: 1.7, textAlign: "center" }}>
              Taking care of the people who spend their careers taking care of everyone else.
            </p>
          </Card>
        </>
      )}
      ...
      {tab === "privacy" && (
        <>
          <Card style={{ background: "rgba(34,197,94,0.05)", borderColor: "rgba(34,197,94,0.15)" }}>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8 }}>
              We do not share personal information, conversations, or wellness check-in data
              with employers, supervisors, or agencies. Your data is not sold, shared, or used for marketing.
            </p>
          </Card>
          ...
          <Card style={{ background: "rgba(56,189,248,0.05)", borderColor: "rgba(56,189,248,0.15)" }}>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8, marginBottom: 8 }}>
              To show you relevant first responder resources, we detect your approximate state using
              your internet connection (IP address) —{" "}
              <span style={{ color: "#dde8f4", fontWeight: 600 }}>not your GPS or device location.</span>
            </p>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8, marginBottom: 8 }}>
              This means we only know what state you are likely in — never your city,
              neighborhood, or street address.
            </p>
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8 }}>
              You can always change your state manually in Settings. No location permission is ever requested.
            </p>
          </Card>
          ...
          <Card>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.75 }}>
              Treated with respect and discretion, consistent with best practices in first
          ...
          <Card>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.75 }}>
              You are always in control of what you share. Many features allow anonymous
              or minimal-input use.
            </p>
          </Card>
          ...
          <Card style={{ background: "rgba(239,68,68,0.06)", borderColor: "rgba(239,68,68,0.18)" }}>
            ...
            {[
              "Someone expresses an immediate risk of harm to themselves or others",
              "Required by applicable laws or emergency intervention protocols",
            ].map((r, i) => (
      ...
      {tab === "security" && (
        <>
          <Card style={{ background: "rgba(56,189,248,0.05)", borderColor: "rgba(56,189,248,0.15)" }}>
            ...
            <p style={{ fontSize: 13, color: "#8099b0", lineHeight: 1.8 }}>
              This platform uses modern security practices to ensure information
              you enter remains protected.
            </p>
          </Card>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }} className="full-width">
            {ROLES.map(r => (
              <div
                ...
                onClick={() => setRole(r)}
                style={{
                  background: role === r ? "rgba(56,189,248,0.1)" : "rgba(255,255,255,0.03)",
                  border: `1.5px solid ${role === r ? "rgba(56,189,248,0.3)" : "rgba(255,255,255,0.07)"}`,
              ...
              >
                ...
                {role === r && (
                  <span style={{ fontSize: 10, color: "#38bdf8", fontWeight: 700, background: "rgba(56,189,248,0.12)", padding: "3px 8px", borderRadius: 6 }}>
                    ACTIVE
                  </span>
                )}
              </div>
        ...
        <>
          <Card>
            ...
            <div style={{ fontSize: 13, color: "#8099b0", marginTop: 4, lineHeight: 1.6 }}>
              Auto-detected from your device. You can change it at any time.
            </div>
            <div style={{
              ...
              {setUserLanguage && (
                <div
                  onClick={() => setUserLanguage(userLanguage === "es" ? "en" : "es")}
                  style={{ fontSize: 13, color: "#38bdf8", fontWeight: 700, cursor: "pointer", textDecoration: "underline", textUnderlineOffset: 3 }}
                >
                  Change
                </div>
              )}
          ...
          <Card>
            ...
            <div style={{ fontSize: 13, color: "#8099b0", marginTop: 4, lineHeight: 1.6 }}>
              Used to show relevant first responder mental health resources and programs in your state and surrounding areas.
            </div>
            <div style={{
              background: "rgba(56,189,248,0.08)",
              border: "1.5px solid rgba(56,189,248,0.2)",
          ...
          <Card style={{ background: "rgba(255,255,255,0.02)", borderColor: "rgba(255,255,255,0.05)" }}>
            ...
            <div style={{ fontSize: 13, color: "#8099b0", marginTop: 8, lineHeight: 1.6 }}>
              Your state selection is stored only on this device and used to filter resources.
              It is never shared or transmitted.
            </div>
          </Card>
        </>
      )}
      ...
      {tab === "account" && (
        <>
          ...
          <Btn color="#38bdf8" onClick={() => onChangeAgency()} className="full-width">
            {agency ? "Change Agency Code" : "Enter Agency Code →"}
          </Btn>

          <Card className="full-width">
            <SLabel>What agency codes unlock:</SLabel>
            {[
              "Human PST availability panel",
              "Contact request flow (Text / Call)",
              "Agency name shown in header",
              "Crew Stream bar on Home Screen",
            ].map((f, i) => (
              <div key={i} style={{
                display: "flex", alignItems: "center", gap: 10,
                padding: "6px 0",
