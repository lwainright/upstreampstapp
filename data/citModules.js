export const CIT_MODULES = {
  pacing: [
    {
      id: "pacing1",
      title: "Slow the Pace",
      steps: [
        "Speak slower than the other person.",
        "Lower your voice and keep it steady.",
  ...
  grounding: [
    {
      id: "ground1",
      title: "Stabilize the Tone",
      steps: [
        "Acknowledge the moment without labels.",
  ...
  choices: [
    {
      id: "choice1",
      title: "Offer Simple Choices",
      steps: [
        "Give no more than two options.",
        "Keep choices low‑pressure and optional.",
        "Use plain language.",
  ...
  space: [
    {
      ...
      title: "Create Space",
      steps: [
        "Give physical and conversational space.",
        "Avoid rushing the moment.",
  ...
  validation: [
    {
      id: "validation1",
      title: "Validate Without Labels",
      steps: [
        "Acknowledge what the person is experiencing.",
        "Avoid naming emotions or diagnosing.",
